...
public class main {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ListaBrinquedo lista = new ListaBrinquedo();

        PokemonBrinquedo brinquedo = new PokemonBrinquedo(32, "BrinksBrinks", lista);
       
        //System.out.println(brinquedo.getNome());
        
        CompraBrinquedo compra = new CompraBrinquedo(lista);
        compra.visualizaUltimaCompra();
